...
// Created: 	2003-03-21
// Ver:		$Id: jpgraph_plotmark.inc.php 5462 2009-02-22 22:58:43Z sandy $
//
...
// PUBLIC METHODS	
    ...
    function AddCSIMPoly($aPts) {
	    ...
	    $this->csimareas .= "<area shape=\"poly\" coords=\"$coords\" href=\"".atk_htmlentities($this->csimtarget)."\"";
    ...
    function AddCSIMCircle($x,$y,$r) {
        ...
        $this->csimareas="";    
        if( !empty($this->csimtarget) ) {
	    $this->csimareas .= "<area shape=\"circle\" coords=\"$x,$y,$r\" href=\"".atk_htmlentities($this->csimtarget)."\"";
	...
	if( $this->type == MARK_IMG ||
		...
		$this->csimareas = "<area shape=\"rect\" coords=\"".
		    ...
		    "href=\"".atk_htmlentities($this->csimtarget)."\"";
